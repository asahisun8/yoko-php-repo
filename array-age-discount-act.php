...
<?php
    if(isset($_POST['btn_submit'])){
        ...
        echo"<p>Ages of the people attending:</p>";
            for($i = 1; $i <= $num_people; $i++){
                echo"<input type='number' name='age[]' placeholder='Enter age here' min='0'><br><br>";
            }
        echo "<input type='submit' name='btn_save' value='Save' class='btn btn-primary w-50'>";
        echo"</form>";      
    }
